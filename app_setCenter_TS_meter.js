...
var ind = 0, h = 0, k = 0, theta = -70, alpha = 0, beta = 0; dLng = 0, dLat = 0, time = 0, steerTime = 0, timeTS = 0, steerTimeTS = 0, latFact = 0, lngFact = 0, Diag = 0;
...
acc = {
    ...
    start: function() {
        if (this.lin != 1.5 && this.lin != 7) {
            timeTS = (new Date()).getTime();
        };
        resSet = true;
        if (Math.trunc(vel.lin) > 0 ) this.lin = 1.5;
        this.lin = 7;
    },
    stop: function() {
        this.lin = 0;
    ...
    rev: function() {
        ...
        resSet = true;
        if (Math.trunc(vel.lin) < 0 ) this.lin = -0.2;
        else this.lin = -15;
    },
    EB: function() {
...
window.onload = function () {
    ...
    setInterval( function dropTime() {
        ...
        traverseBy(vel.lin * 0.00015); moveDest();
